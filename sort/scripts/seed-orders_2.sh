...
grpcurl -d "{\"items\":$items_1}" -plaintext 0.0.0.0:10000 sorting.SortingRobot.LoadItems
grpcurl -d "{\"items\":$items_2}" -plaintext 0.0.0.0:10000 sorting.SortingRobot.LoadItems
grpcurl -d "{\"items\":$items_3}" -plaintext 0.0.0.0:10000 sorting.SortingRobot.LoadItems
grpcurl -d "{\"items\":$items_4}" -plaintext 0.0.0.0:10000 sorting.SortingRobot.LoadItems
grpcurl -d "{\"items\":$items_5}" -plaintext 0.0.0.0:10000 sorting.SortingRobot.LoadItems
grpcurl -d "{\"items\":$items_6}" -plaintext 0.0.0.0:10000 sorting.SortingRobot.LoadItems
grpcurl -d "{\"items\":$items_7}" -plaintext 0.0.0.0:10000 sorting.SortingRobot.LoadItems
grpcurl -d "{\"items\":$items_8}" -plaintext 0.0.0.0:10000 sorting.SortingRobot.LoadItems
grpcurl -d "{\"items\":$items_9}" -plaintext 0.0.0.0:10000 sorting.SortingRobot.LoadItems
grpcurl -d "{\"items\":$items_10}" -plaintext 0.0.0.0:10000 sorting.SortingRobot.LoadItems
...
grpcurl \
    ...
    -plaintext 0.0.0.0:10001 fulfillment.Fulfillment.LoadOrders